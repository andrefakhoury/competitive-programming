...
int main() {
    ...
    Point<long double> s1(x1, y1);
    Point<long double> s2(x1, y2);
    Point<long double> s3(x2, y1);
    Point<long double> s4(x2, y2);
    Point<long double> p1(x, y);

    Point<long double> c;
    long double ans;

    long double dist1 = p1.distToSegment(s1, s2, c);
    long double dist2 = p1.distToSegment(s1, s3, c);
    long double dist3 = p1.distToSegment(s2, s4, c);
    long double dist4 = p1.distToSegment(s3, s4, c);
    
    ans = min({dist1,dist2,dist3,dist4});
